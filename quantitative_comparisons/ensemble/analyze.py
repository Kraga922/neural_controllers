...
def load_and_bag_predictions_pairs(results_path, ensemble_pairs, model_name, prompt_version='v1'):
    """
    ...
    for prediction_type, control_method in ensemble_pairs:
        pred_path = os.path.join(
            results_path, f"{model_name}_{control_method}_prompt_{prompt_version}_predictions.pkl"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='pubmedQA', help='Dataset name (default: pubmedQA)')
    parser.add_argument('--model_name', type=str, default='llama_3.3_70b_4bit_it', help='Model name (default: llama_3.3_70b_4bit_it)')
    parser.add_argument('--prompt_version', type=str, default='v1', help='Prompt version (default: v1)')
